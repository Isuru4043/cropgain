...
function IncomeTable() {
      ...
      <div className="flex items-center space-x-4">
        ...
        <button 
          className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors 
            ${filterActive ? 'bg-blue-100 text-green-600' : 'bg-gray-100 hover:bg-gray-200'}`}
  ...
  const StatCards = () => (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
      {[
        { title: "Total Income", value: `LKR ${totalIncome.toFixed(2)}`, change: "+12.5%", icon: "💰" },
        { title: "Active Crops", value: crops.length, change: "+2", icon: "🌾" },
        { title: "Avg. Income/Crop", value: `LKR ${(totalIncome / crops.length).toFixed(2)}`, change: "+5.3%", icon: "📈" },
          ...
          <div className="flex justify-between items-center flex-wrap">
            ...
            <div className="space-x-2 mt-2 sm:mt-0">
              <button
                ...
                className={`px-3 py-1 rounded ${activeChart === "pie" ? "bg-green-500 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`}
              >
                Pie Chart
              </button>
              <button
