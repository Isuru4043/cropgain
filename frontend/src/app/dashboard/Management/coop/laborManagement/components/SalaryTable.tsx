...
const generateMockData = () => {
  ...
  years.forEach(year => {
    for (let month = 1; month <= 12; month++) {
      ...
      const daysInMonth = month === 2 && year % 4 === 0 ? 29 : monthDays[month - 1];
    ...
    <div className="bg-white rounded-lg p-4 space-y-6 shadow-md">
        ...
        <table className="min-w-full text-left">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="py-3 px-4 text-sm font-medium text-gray-700">Overtime</th>
              ...
              <>
                {salaries.map((s) => (
                  <React.Fragment key={s.id}>
                    <tr className="hover:bg-gray-50">
                      <td className="py-3 px-4 border-t text-sm font-medium">{s.name}</td>
                      <td className="py-3 px-4 border-t text-sm">Rs.{s.baseSalary}</td>
                      <td className="py-3 px-4 border-t text-sm">Rs.{s.overtime}</td>
                      <td className="py-3 px-4 border-t text-sm">Rs.{s.deductions}</td>
                      ...
                      <td className="py-3 px-4 border-t text-sm">
                        <div className="flex space-x-2">
                          ...
                          <button 
                            onClick={() => handleEditEmployee(workerHours.find(wh => wh.id === s.id)!)}
                        ...
                        <td colSpan={6} className="py-3 px-4 bg-gray-50">
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            <div>
                              ...
                              <p>Regular: {workerHours.find(wh => wh.id === s.id)?.hoursWorked} hrs</p>
                              <p>Overtime: {workerHours.find(wh => wh.id === s.id)?.overtimeHours} hrs</p>
                              <p>Hourly Rate: Rs.{workerHours.find(wh => wh.id === s.id)?.hourlyRate}/hr</p>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <p>Direct Deposit</p>
                              <p>Statement Available: <span className="text-blue-600 cursor-pointer">Download</span></p>
                            </div>
                          </div>
                        </td>
                      </tr>
                ...
                {summary && (
                  <tr className=" font-medium bg-blue-100">
                    ...
                    <td className="py-3 px-4 border-t text-sm">Rs.{summary.totalOvertime}</td>
      ...
      <div className="md:hidden space-y-4">
        {salaries.length > 0 ? (
          <>
            {salaries.map((s) => (
              <div key={s.id} className="border rounded-lg p-4 space-y-3 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <p>Base Salary: <span className="font-medium">Rs.{s.baseSalary}</span></p>
                  <p>Overtime: <span className="font-medium">Rs.{s.overtime}</span></p>
                  <p>Deductions: <span className="font-medium">Rs.{s.deductions}</span></p>
                </div>
                ...
                {showDetails === s.id && (
                  <div className="mt-3 pt-3 border-t space-y-3 text-sm">
                    ...
                    <div>
                      <p className="text-xs text-blue-600">Download Pay Statement</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            {summary && (
              <div className="border-t pt-4 mt-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <p>Total Base: <span className="font-medium">Rs.{summary.totalBaseSalary}</span></p>
                  <p>Total Overtime: <span className="font-medium">Rs.{summary.totalOvertime}</span></p>
                  <p>Total Deductions: <span className="font-medium">Rs.{summary.totalDeductions}</span></p>
                  <p>Total Net Pay: <span className="font-medium">Rs.{summary.totalNetPay}</span></p>
                </div>
              </div>
            )}
          </>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditEmployee({...editEmployee, hoursWorked: parseInt(e.target.value) || 0})}
                    className="w-full border rounded px-3 py-2 text-sm"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditEmployee({...editEmployee, overtimeHours: parseInt(e.target.value) || 0})}
                    className="w-full border rounded px-3 py-2 text-sm"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditEmployee({...editEmployee, hourlyRate: parseFloat(e.target.value) || 0})}
                    className="w-full border rounded px-3 py-2 text-sm"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditEmployee({...editEmployee, deductions: parseInt(e.target.value) || 0})}
                    className="w-full border rounded px-3 py-2 text-sm"
                  />
                </div>
              </div>
              ...
              <div className="hidden">
                ...
                <input
                  ...
                  onChange={(e) => setEditEmployee({...editEmployee, tax: parseInt(e.target.value) || 0})}
                  className="w-full border rounded px-3 py-2 text-sm"
                />
              </div>
            </div>
